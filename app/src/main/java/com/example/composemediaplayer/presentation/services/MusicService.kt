...
class MusicService : Service() {
    ...
    override fun onCreate() {
        ...
        exoPlayer = ExoPlayer.Builder(this).build().apply {
            val mediaItem =
                MediaItem.fromUri(Uri.parse("https://storage.googleapis.com/exoplayer-test-media-0/play.mp3"))
    ...
    private fun showNotification() {
        ...
        val replyIntent = Intent(this, MusicService::class.java).apply {
            putExtra(INTENT_COMMAND, INTENT_COMMAND_REPLY)
        }


        val achieveIntent = Intent(this, MusicService::class.java).apply {
